...
export const tradeApi = {
  ...
  submit: (identityReference: string) => api.post<Verification>('/verifications/me', { identityReference }).then(r => r.data),
  ...
  review: (id: number, status: VerificationStatus, notes: string) => api.post<VerificationReview>(`/evaluator/verifications/${id}/review`, { status, notes }).then(r => r.data),
}
